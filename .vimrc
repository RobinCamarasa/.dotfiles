...
"     autocmd TerminalOpen setlocal number relativenumber
" augroup end 
"}}}
...
augroup pytest_group
    ...
    autocmd BufNewFile,BufRead test*.py nnoremap <leader>T :execute "normal! mm?^def\r2eyiw`m"<CR>:let b:recipe=expand('%') . "::<c-r>0"<CR>
...
" FILETYPE sh {{{
augroup mlflow_group
    autocmd BufNewFile,BufRead MLproject setlocal filetype=yaml
augroup END
" }}}
